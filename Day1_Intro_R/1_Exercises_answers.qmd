...
print(paste("This is the area:", triangle))
print(paste("This is the answer", triangle, "and after..."))
```
...
print(reverse_list(c(1, 2, 3, 4, 5)))
```
...
print(calculate_mean(c(1, 2, 3, 4, 5)))
```
...
print(find_lines_with_word("example.txt", "specific_word"))
```
